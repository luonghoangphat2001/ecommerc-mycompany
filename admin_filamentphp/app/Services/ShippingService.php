...
use App\Contracts\Repositories\ShippingZoneRepositoryInterface;
...
class ShippingService implements ShippingServiceInterface
{
    ...
    public function getAvailableMethods(?string $country = null, ?string $state = null, ?string $postcode = null, ?string $ward = null, int $subtotal = 0)
    {
        ...
        $drivers = [
            'flat_rate' => \App\Services\Shipping\Drivers\FlatRateDriver::class,
            'free_shipping' => \App\Services\Shipping\Drivers\FreeShippingDriver::class,
        ];
