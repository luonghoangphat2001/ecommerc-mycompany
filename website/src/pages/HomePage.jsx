        ...
        <div className="w-full -mt-8">
            ...
            {featuredProducts.length > 0 && (
                <section className="mb-24">
                    <div className="flex items-end justify-between mb-10">
                        <div>
                            <PageHeading as="h2" className="mb-2">Sản phẩm nổi bật</PageHeading>
            ...
            <section className="bg-slate-900 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden mb-12">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-slate-400 text-lg mb-10 max-w-2xl mx-auto">Đăng ký nhận bản tin để nhận ưu đãi 10% cho đơn hàng đầu tiên và cập nhật những bộ sưu tập mới nhất.</p>
                    <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                        <input type="email" placeholder="Nhập email của bạn..." className="flex-1 bg-white/10 border border-white/20 rounded-2xl px-6 py-4 text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all" />
                        <Button variant="blue" size="xl" className="!px-8 !py-4 shadow-blue-900/20">Đăng ký</Button>
                    </div>
                </div>
            </section>
        </div>
