...
const Header = () => {
    const { user, _hasHydrated, cartCount, settings, language, currency, isMobileMenuOpen, setLanguage, setCurrency, translate, handleLogout, toggleMobileMenu, closeMobileMenu } = useHeader()
